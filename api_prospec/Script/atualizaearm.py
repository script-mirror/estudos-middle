...
class Paths:
    ...
    BASE_PATH = Path('/WX2TB/Documentos/fontes/PMO')
    COD = BASE_PATH / 'API_Prospec/DadosCalculoVolume'
    RDH = BASE_PATH / 'monitora_ONS/plan_acomph_rdh'
    OUTPUT = BASE_PATH / 'API_Prospec/GerarDecks/VOLUME'
