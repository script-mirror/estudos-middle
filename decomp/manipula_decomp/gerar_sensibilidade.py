...
from dadger_processor import *
from atualiza_decomp import process_decomp
sys.path.append('/WX2TB/Documentos/fontes/PMO/API_Prospec/Script/')
sys.path.append('/WX2TB/Documentos/fontes/PMO/rodada_automatica_prospec/script/')
from functionsProspecAPI import *
from mainRodadaAutoProspec import runWithParams

ABS_PATH = '/WX2TB/Documentos/fontes/PMO/gera_sens_prospec'
ABS_PATH_LOG = os.path.join(ABS_PATH, 'output/log', 'logging.log')
...
def gerar_estudo_prospec(params):
    ...
    params['pq_load_level'] = ''
    params['load_level_data'] = ''
