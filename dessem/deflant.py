...
def gerarDeflant(data, pathArquivos):
	...
	entdados = entdados.leituraArquivo(pathEntdadosIn)
	infoBlocosEntdados = entdados.getInfoBlocos()
	blocoTVIAG = entdados.extrairInfoBloco(entdados, 'TVIAG', infoBlocosEntdados['TVIAG']['regex'])
...
if __name__ == '__main__':
	...
	import dessem.entdados as entdados
	import wx_dbLib
